            ...
            <v-simple-table height="300" dense fixed-header>
              ...
              <tbody>
                <tr v-for="cta in cuentas" :key="cta.id">
                  ...
                  <td><v-text-field type="text" class="numero" v-model="cta.debe" dense hide-details/></td>
                  <td><v-text-field type="text" class="numero" v-model="cta.haber" dense hide-details/></td>
                  <td><v-btn small fab text color="red"><v-icon small>mdi-close</v-icon></v-btn></td>
                </tr>
              </tbody>
              <tfoot v-if="cuentas.length > 0">
        ...
        <v-card-text>
          <v-flex class="pa-2">
            ...
            <v-simple-table dense fixed-header height="300">
              ...
              <tbody>
                <tr v-for="cta in cuentasDetalle" :key="cta.value" @dblclick="cuentas.push({id:cta.id,cuenta:cta.cuenta,descripción:cta.descripción,debe:0,haber:0})">
                  <td>{{cta.cuenta}}</td>
                  <td>{{cta.descripción}}</td>
                </tr>
              </tbody>
